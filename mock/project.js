...
const projectDetailMockData = [
  ...
  },
  {
    ...
    saveTemplate: false,
    templateName: '',
    setting: { classifyName: '情感', multiple: false, options: [{ optionName: '高兴', color: '#1890ff' }, { optionName: '愤怒', color: '#1890ff' }, { optionName: '悲伤', color: '#1890ff' }, { optionName: '惊喜', color: '#1890ff' }, { optionName: '中性', color: '#1890ff' }] },
    explain: '',
    labelSchedule: 0,
    reviewSchedule: 0,
    status: 'inProgress',
...
const videoLabelData = [
  {
    ...
    labelResult: [{
      videoBasicInfo: {
        ...
        dialogTime: ['2020-05-29 10:00', '2020-05-29 11:00'],
        receptionCostTime: '02:10',
        dialogScene: '银行',
        dialogTarget: '营销产品',
        videoRemark: '这是基本信息备注',
      },
      userInfo: [
        {
          userId: 1,
...
export default {
  ...
  'POST /api/project/export-result': exportResult,
  ...
  'POST /api/task-manage/prev-question': getPrevTextQuestion,
};
